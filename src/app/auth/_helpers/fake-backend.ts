        ...
        setTimeout(() => {
            ...
            if (connection.request.url.endsWith('/api/authenticate') && connection.request.method === RequestMethod.Post) {
                ...
                if (filteredUsers.length) {
                    ...
                    connection.mockError(new Error('نام کاربری و یا رمز عبور شما اشتباه می باشد'));
                }
            ...
            if (connection.request.url.endsWith('/api/users') && connection.request.method === RequestMethod.Post) {
                ...
                if (duplicateUser) {
                    return connection.mockError(new Error('ایمیل  "' + newUser.email + '" قبلا ثبت شده است '));
                }
            ...
            if (connection.request.url.endsWith('/api/forgot-password') && connection.request.method === RequestMethod.Post) {
                ...
                if (filteredUsers.length) {
                    ...
                    // else return 400 bad request
                    connection.mockError(new Error('کاربری با این مشخصات موجود نمی باشد'));
                }
